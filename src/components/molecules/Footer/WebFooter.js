...
const WebFooter = () => {
  ...
  return (
    <Box component="footer" sx={{ bgcolor: "#1867bf", color: "white", py: 6 }}>
          ...
          <Grid item xs={12} md={3}>
            ...
            <Stack spacing={1}>
              ...
              <Box display="flex" alignItems="center" gap={1}>
                ...
                <Typography variant="body2">0538507454</Typography>
              </Box>
              <Box display="flex" alignItems="center" gap={1}>
                <Email fontSize="small" />
                <Typography variant="body2">info@aliiec.com</Typography>
              </Box>
            </Stack>
          </Grid>
